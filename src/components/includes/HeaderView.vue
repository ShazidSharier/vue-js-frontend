<template>
    ...
    <header class="header">
            ...
            <div class="container">
                <div class="header-left mr-md-4">
                    ...
                    <router-link :to="{name:'home'}" class="logo ml-lg-0">
                        <img src="assets/images/demos/demo3/header-logo.png" alt="logo" width="144" height="45" />
                    </router-link>
                    ...
                    <div class="header-call d-xs-show d-lg-flex align-items-center">
                        ...
                        <div class="call-info d-lg-show">
                            <h4 class="chat font-weight-normal font-size-md text-normal ls-normal text-light mb-0">
                                <a href="https://portotheme.com/cdn-cgi/l/email-protection#7e5d" class="text-capitalize">Call Us Now</a> :</h4>
        ...
        <div class="sticky-content fix-top sticky-header has-dropdown">
            <div class="container">
...
<script>
    ...
    export default {
        ...
        methods: {
            getAllCategory()
            {
                axios.get("http://localhost/ecom-final-11/public/api/get-all-category").then((response) => {
