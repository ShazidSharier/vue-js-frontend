                                                ...
                                                <div class="swiper-wrapper row cols-1 gutter-no">
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/1-1-600x675.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/1-2-600x675.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/1-3-600x675.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/1-4-600x675.jpg"
                                        ...
                                        <div class="product-gallery product-gallery-vertical mb-0">
                                            <div class="swiper-container product-single-swiper swiper-theme nav-inner">
                                                <div class="swiper-wrapper row cols-1 gutter-no">
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/2-1-600x675.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/2-2-600x675.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/2-3-600x675.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="assets/images/demos/demo3/products/2-4-600x675.jpg"
                            ...
                            <div class="swiper-wrapper row cols-lg-1 cols-md-3">
                                <div class="swiper-slide product-widget-wrap">
                                    <div class="product product-widget bb-no">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-1.jpg" alt="Product"
                                    ...
                                    <div class="product product-widget bb-no">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-2.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product product-widget">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-3.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                ...
                                <div class="swiper-slide product-widget-wrap">
                                    <div class="product product-widget bb-no">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-4.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product product-widget bb-no">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-5.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product product-widget">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-6.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                ...
                                <div class="swiper-slide product-widget-wrap">
                                    <div class="product product-widget bb-no">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-7.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product product-widget bb-no">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-8.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product product-widget">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/demos/demo3/products/1-9.jpg" alt="Product"
                                                     width="105" height="118" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
