                ...
                <div class="container">
                    ...
                    <div class="shop-content row gutter-lg mb-10">
                        ...
                        <div class="main-content">
                            ...
                            <div class="product-wrapper row cols-md-3 cols-sm-2 cols-2" v-for="(product,key) in products" :key="key">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            {
                axios.get("http://localhost/ecom-final-11/public/api/get-all-category-product/"+this.id).then((response) => {
